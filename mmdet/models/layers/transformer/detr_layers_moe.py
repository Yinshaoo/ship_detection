...
class MoEDetrTransformerEncoder(BaseModule):
    """Encoder of DETR.
    ...
    def _init_layers(self) -> None:
        ...
        self.layers = ModuleList([
            MoEDetrTransformerEncoderLayer(**self.layer_cfg)
...
class MoEDetrTransformerEncoderLayer(BaseModule):
    ...
    def _init_layers(self) -> None:
        ...
        self.moe = SparseMoE(**self.moe_cfg)
        norms_list = [
