...
from mmdet.models.layers.transformer.detr_layers_moe import MoEDetrTransformerEncoder
...
class MOEHybridEncoder(BaseModule):
    """HybridEncoder.
    ...
    def __init__(self,
                 ...
                 act_cfg: OptConfigType = dict(type='SiLU', inplace=True),
                 eval_size=None):
        super(MOEHybridEncoder, self).__init__()
        self.in_channels = in_channels
        ...
        self.encoder = ModuleList([
            MoEDetrTransformerEncoder(num_encoder_layers, layer_cfg)
