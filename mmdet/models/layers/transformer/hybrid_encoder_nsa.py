...
from mmdet.models.layers.transformer.detr_layers_NSA import NSADetrTransformerEncoder
...
class NSAHybridEncoder(BaseModule):
    """HybridEncoder.
    ...
    def __init__(self,
                 ...
                 act_cfg: OptConfigType = dict(type='SiLU', inplace=True),
                 eval_size=None):
        super(NSAHybridEncoder, self).__init__()
        self.in_channels = in_channels
        ...
        self.encoder = ModuleList([
            NSADetrTransformerEncoder(num_encoder_layers, layer_cfg)
