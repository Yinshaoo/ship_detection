...
launcher = 'none'
load_from = 'work_dirs/rtdetr_r50vd_8xb2-72e_coco_improved/epoch_71.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=72, type='EpochBasedTrainLoop', val_interval=6)
...
work_dir = './work_dirs/rtdetr_r50vd_8xb2-72e_coco_improved'
